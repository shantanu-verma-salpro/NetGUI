...
namespace ImGuiNET
{
    public static class DxResources
    {
        ...
        public static unsafe IntPtr imguiDxData = (IntPtr)NativeMemory.AllocZeroed((nuint)Marshal.SizeOf<ImGuiDxData>());
        public static readonly unsafe IntPtr vertexShaderCode = Marshal.StringToHGlobalAnsi(@"cbuffer vertexBuffer : register(b0)
                    {
        ...
        public static readonly unsafe IntPtr vsTarget = Marshal.StringToHGlobalAnsi("vs_4_0");
        public static readonly unsafe IntPtr idxTarget = Marshal.StringToHGlobalAnsi("ps_4_0");
        public static readonly unsafe IntPtr pixelShaderCode = Marshal.StringToHGlobalAnsi(
            @"struct PS_INPUT
            {
                float4 pos : SV_POSITION;
                float4 col : COLOR0;
        ...
        public static readonly unsafe IntPtr entrypoint = Marshal.StringToHGlobalAnsi("main");
        public static readonly unsafe IntPtr position = Marshal.StringToHGlobalAnsi("POSITION");
        public static readonly unsafe IntPtr texcoord = Marshal.StringToHGlobalAnsi("TEXCOORD");
        public static readonly unsafe IntPtr color = Marshal.StringToHGlobalAnsi("COLOR");
